...
class CacheService:
    ...
    def cache_plans_list(self, category: Optional[str] = None, 
                        plans_data: List[Dict[str, Any]] = None, 
    ...
    def cache_devices_list(self, brand: Optional[str] = None, 
                          devices_data: List[Dict[str, Any]] = None,
                          ttl: Optional[int] = None) -> bool:
        """단말기 목록 캐싱"""
    ...
    # 번호 캐싱
    def cache_available_numbers(self, category: str, numbers_data: List[Dict[str, Any]], 
                               ttl: Optional[int] = None) -> bool:
        """사용 가능한 번호 목록 캐싱"""
    ...
    def cache_number_search(self, search_query: str, results: List[Dict[str, Any]], 
                           ttl: Optional[int] = None) -> bool:
        """번호 검색 결과 캐싱"""
        # 검색 쿼리를 해시화하여 키로 사용
    ...
    # 사용자 세션 캐싱
    def cache_user_session(self, user_id: int, session_data: Dict[str, Any], 
                          ttl: Optional[int] = None) -> bool:
        """사용자 세션 데이터 캐싱"""
    ...
    # 통계 데이터 캐싱
    def cache_stats(self, stats_type: str, stats_data: Dict[str, Any], 
                   ttl: Optional[int] = None) -> bool:
        """통계 데이터 캐싱"""
