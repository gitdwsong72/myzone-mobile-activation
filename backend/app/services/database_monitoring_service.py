...
from ..core.database import check_db_connection, get_pool_status
...
class DatabaseMonitoringService:
    ...
    def _get_index_efficiency(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"usage_stats": usage_stats, "unused_indexes": unused_indexes}
        except Exception as e:
    ...
    def get_maintenance_recommendations(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            recommendations.append(
                {"type": "error", "priority": "high", "description": f"유지보수 권장사항 생성 중 오류 발생: {e}"}
            )
