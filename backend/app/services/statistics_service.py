...
class StatisticsService:
    ...
    def get_overview_stats(self) -> Dict[str, Any]:
        ...
        this_month_orders = (
            self.db.query(Order)
            .filter(Order.created_at >= this_month_start)
            .count()
        )
    ...
    def get_order_status_stats(self) -> Dict[str, Any]:
        ...
        processing_times = (
            self.db.query(
                func.avg(
                    func.extract('epoch', OrderStatusHistory.created_at) - 
    ...
    def get_device_stats(self) -> Dict[str, Any]:
        ...
        brand_stats = (
            self.db.query(
                Device.brand,
                func.count(Order.id).label('order_count'),
                func.sum(Order.device_fee).label('total_revenue')
            )
    ...
    def get_user_stats(self) -> Dict[str, Any]:
        ...
        new_users_this_month = (
            self.db.query(User)
            .filter(User.created_at >= this_month_start)
            .count()
        )
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        # 고객 생애 가치 (LTV) - 간단한 계산
        avg_customer_orders = (
            self.db.query(func.avg(func.count(Order.id)))
