...
from app.models import Plan, Device, Admin, Number
    ...
    plans_data = [
        # 5G 요금제
        {
            ...
            "additional_services": json.dumps([
                "5G 네트워크", "무제한 데이터", "무제한 통화", "무제한 문자",
                "Netflix 베이직", "YouTube Premium", "해외로밍 10GB"
            ]),
            "discount_rate": 0,
        ...
        },
        {
            ...
            "sms_count": None,  # 무제한
            "additional_services": json.dumps([
                "5G 네트워크", "100GB 데이터", "무제한 통화", "무제한 문자"
            ]),
            "discount_rate": 10,
        ...
        # LTE 요금제
        {
            ...
            "sms_count": None,  # 무제한
            "additional_services": json.dumps([
                "LTE 네트워크", "무제한 데이터", "무제한 통화", "무제한 문자"
            ]),
            "discount_rate": 0,
            "promotion_text": None,
            "is_active": True,
        ...
        },
        {
            ...
            "sms_count": None,  # 무제한
            "additional_services": json.dumps([
                "LTE 네트워크", "50GB 데이터", "무제한 통화", "무제한 문자"
            ]),
            "discount_rate": 0,
            "promotion_text": None,
            "is_active": True,
    ...
    devices_data = [
        # 삼성 갤럭시
        {
            ...
            "image_urls": json.dumps([
                "/images/devices/galaxy-s24-ultra-gray-1.jpg",
                "/images/devices/galaxy-s24-ultra-gray-2.jpg"
            ]),
            "is_active": True,
            "is_featured": True,
            "display_order": 1,
