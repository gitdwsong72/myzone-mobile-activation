...
class TestOrderWorkflow:
    ...
    def test_complete_order_workflow(self, client, db_session, created_user, created_plan, created_device, created_number, created_admin):
        """전체 주문 워크플로우 통합 테스트"""
    ...
    def test_order_cancellation_workflow(self, client, db_session, created_user, created_plan, created_device, created_number, created_admin):
        """주문 취소 워크플로우 테스트"""
    ...
    def test_payment_failure_workflow(self, client, db_session, created_user, created_plan, created_device, created_number, created_admin):
        """결제 실패 워크플로우 테스트"""
    ...
    def test_concurrent_number_reservation(self, client, db_session, created_user, created_plan, created_device, created_number, created_admin):
        """동시 번호 예약 처리 테스트"""
    ...
    def test_order_statistics_integration(self, client, db_session, created_user, created_plan, created_device, created_number, created_admin):
        """주문 통계 통합 테스트"""
    ...
    def test_notification_integration(self, client, db_session, created_user, created_plan, created_device, created_number, created_admin):
        """알림 시스템 통합 테스트"""
